...
const UsersFilter = ({ 
  ...
  return (
    // CAMBIO: Quitamos bg-white, shadow, p-4, mb-6. 
    // Ahora es solo un contenedor flex que se ajusta al ancho necesario.
    <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
      ...
      {/* 2. Filtros (Los agrupamos para que no se separen) */}
